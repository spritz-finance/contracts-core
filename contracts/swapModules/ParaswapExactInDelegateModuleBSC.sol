...
contract ParaswapExactInDelegateModuleBSC is ExactInputDelegateSwapModule {
    ...
    address private constant AUGUSTUS_SWAPPER = 0xDEF171Fe48CF0115B1d80b88dc8eAB59176FEe57;
    ...
    function _exactInputSwap(ExactInputParams memory swapParams) private returns (address, uint256) {
        ...
        if (augustus != AUGUSTUS_SWAPPER) revert InvalidSwapTarget();
