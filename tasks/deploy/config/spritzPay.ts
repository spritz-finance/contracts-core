import {
  ...
  SPRITZPAY_STAGING_BASE_ADDRESS,
...
export const spritzPayContractConfig: Record<string, Record<string, { proxy: string; args: any[] }>> = {
  staging: {
    ...
    base: {
      proxy: SPRITZPAY_STAGING_BASE_ADDRESS,
      args: [ADMIN_BASE, TEAM_WALLET_BASE, NULL_ADDRESS, WETH_BASE_ADDRESS, ACCEPTED_STABLECOINS_BASE],
    },
  },
  production: {
    polygon: {
    ...
    base: {
      proxy: SPRITZPAY_BASE_ADDRESS,
      args: [ADMIN_BASE, SPRITZ_TREASURY_WALLET, NULL_ADDRESS, WETH_BASE_ADDRESS, ACCEPTED_STABLECOINS_BASE],
    },
  },
};
